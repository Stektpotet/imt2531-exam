...
This code is sourced from https://github.com/syoyo/tinyobjloader - 07.05.2018
All credit goes to the authors of this project.

Modifications:
* Removed any files from the repo which we did not need to compile
* This includes test, examples, .dotfiles, images, documentation...
